...
- [ ] **Editorial Typography**
    - [ ] Integrate `Playfair Display` for editorial elements (pull quotes, featured collections).
    - [ ] Enable variable font capabilities for `Inter` for better optical sizing.
    - [ ] Implement Micro-Typography: `0.75rem` uppercase with `0.1em` letter-spacing for category labels.
- [ ] **"Sand & Ebony" Color Palette**
    - [ ] Update background to Off-white/Cream (`#FDFCFB`).
    - [ ] Update primary color to Deep Charcoal/Ebony (`#1A1A1A`).
    - [ ] Update accent color to Muted Terra Cotta/Brass (`#C5A07D`).
- [ ] **Tactile Texture**
    - [ ] Add a low-opacity noise/grain texture overlay to the entire site.
